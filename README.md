...
Another piece of functionality provided by the module is an implementation of [RFC 6901](https://tools.ietf.org/html/rfc6901) JSON Pointers. A pointer can be parsed into a `PropertyPointer` class object using module's `parseJSONPointer()` function:
...
const ptr = records.parseJSONPointer(
